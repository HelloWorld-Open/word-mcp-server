...
让你的 AI 智能体直接操控 Microsoft Word。80 个工具，覆盖创建、编辑、排版、表格、图表、图片、书签、页眉页脚、批注等全流程。Word 以可见窗口运行，每条修改即时呈现，Ctrl+Z 全程有效。
...
- **80 个工具** — 文本、表格、图表、图片、页眉页脚、批注、书签，精准操控每个细节
- **流式 Markdown** — `start → block → end` 三步写文档，即时预览，字体/样式自动继承
- **自动光标管理** — 页眉/页脚/表格/标记操作后自动复位光标，无需手动调整位置
...
- [TOOLS.zh-CN.md](./TOOLS.zh-CN.md) — 80 工具速查
