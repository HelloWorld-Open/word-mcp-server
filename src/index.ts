...
const instructions = [
  ...
  "Rich elements not expressible in markdown use word_mgr_* tools: chart, image, textbox, header, footer, page_numbers, watermark, bookmark, comment, footnote, section_break.",
...
"  3. word_mgr_set_header({text:'My Report', alignment:'center'}) → page header",
"  4. word_mgr_set_page_numbers({target:'footer'}) → page numbers",
...
"  7. word_mgr_insert_table({rows:5, columns:3, data:[...]}) → rich table",
"  8. word_mgr_insert_chart({type:'bar', data:[...], title:'Results'}) → chart",
"  9. word_mgr_set_watermark({text:'DRAFT'}) → watermark",
