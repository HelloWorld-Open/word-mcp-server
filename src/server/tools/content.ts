...
export function registerContentTools(
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_insert_paragraph", async ({ count }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_insert_page_break", async () => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_insert_horizontal_line", async () => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_insert_list", async ({ type, items }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_add_hyperlink", async ({ text, address, subAddress, screenTip }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_add_footnote", async ({ text }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_insert_section_break", async ({ type }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_set_columns", async ({ count, spacing }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_find_text", async ({ findText, matchCase, matchWholeWord, direction, wrap }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_go_to_paragraph", async ({ index }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_find_replace", async ({ findText, replaceWith, matchCase, matchWholeWord, replaceAll }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_go_to", async ({ what, which }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_select_all", async () => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_select_text", async ({ start, length }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_select_current_word", async () => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_select_current_paragraph", async () => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_delete", async () => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_backspace", async ({ count }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_copy", async () => {
      await content.copy()
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_cut", async () => {
      await content.cut()
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_paste", async () => {
      await content.paste()
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_undo", async ({ count }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_redo", async ({ count }) => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_get_cursor_info", async () => {
  ...
  server.registerTool(
    ...
    mcpCall(security, context, "word_insert_file", async ({ path }) => {
